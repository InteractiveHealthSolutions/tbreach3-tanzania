...
public interface ServerServiceAsync
{
	...
	void findSmsRule (String smsRuleId, AsyncCallback<SmsRules> callback) throws Exception;

	void findSmsRecipient (String smsRecipientId, AsyncCallback<SmsRecipient> callback) throws Exception;
	
	void findSmsRecipients (AsyncCallback<SmsRecipient[]> asyncCallback);
	...
	//void saveSmsRule (SmsRules smsRule, AsyncCallback<void> callback) throws Exception;
	...
	void updateSmsRule (SmsRules[] smsRule, AsyncCallback<Boolean> callback) throws Exception;

	void updateSmsRule (SmsRules smsRule, AsyncCallback<Boolean> callback) throws Exception;
	
	void updateSmsRecipient (SmsRecipient[] smsRule, AsyncCallback<Boolean> callback) throws Exception;
	...
	void generatePDFfromQuery (String database, String query, AsyncCallback<String> callback) throws Exception;
	...
	void getLatestColumnData (String tableName, String columnName, String filter, AsyncCallback<String[]> callback) throws Exception;
	...
	void getGeneXpertResultAsList (AsyncCallback<AlertSentGeneXpertResults[]> callback);
